...
def build_model(image_size,
    ...
    conv1 = Conv2D(64, (3, 3), name='conv1', strides=(1, 1), padding="same")(normed)
    conv1 = Conv2D(64, (3, 3), name='conv1a', strides=(1, 1), padding="same")(conv1)
    conv1 = BatchNormalization(axis=3, momentum=0.99, name='bn1')(conv1) # Tensorflow uses filter format [filter_height, filter_width, in_channels, out_channels], hence axis = 3
    conv1 = ELU(name='elu1')(conv1)
    pool1 = MaxPooling2D(pool_size=(2, 2), name='pool1')(conv1)

    conv2 = Conv2D(128, (3, 3), name='conv2', strides=(1, 1), padding="same")(pool1)
    conv2 = Conv2D(128, (3, 3), name='conv2a', strides=(1, 1), padding="same")(conv2)
    conv2 = BatchNormalization(axis=3, momentum=0.99, name='bn2')(conv2)
    conv2 = ELU(name='elu2')(conv2)
    pool2 = MaxPooling2D(pool_size=(2, 2), name='pool2')(conv2)

    conv3 = Conv2D(256, (3, 3), name='conv3', strides=(1, 1), padding="same")(pool2)
    conv3 = Conv2D(256, (3, 3), name='conv3a', strides=(1, 1), padding="same")(conv3)
    conv3 = Conv2D(256, (3, 3), name='conv3b', strides=(1, 1), padding="same")(conv3)
    conv3 = Conv2D(256, (3, 3), name='conv3c', strides=(1, 1), padding="same")(conv3)
    conv3 = BatchNormalization(axis=3, momentum=0.99, name='bn3')(conv3)
    conv3 = ELU(name='elu3')(conv3)
    pool3 = MaxPooling2D(pool_size=(2, 2), name='pool3')(conv3)


    conv4 = Conv2D(512, (3, 3), name='conv4', strides=(1, 1), padding="same")(pool3)
    conv4 = Conv2D(512, (3, 3), name='conv4a', strides=(1, 1), padding="same")(conv4)
    conv4 = Conv2D(512, (3, 3), name='conv4b', strides=(1, 1), padding="same")(conv4)
    conv4 = Conv2D(512, (3, 3), name='conv4c', strides=(1, 1), padding="same")(conv4)
    conv4 = BatchNormalization(axis=3, momentum=0.99, name='bn6')(conv4)
    conv4 = ELU(name='elu6')(conv4)
    pool4 = MaxPooling2D(pool_size=(2, 2), name='pool6')(conv4)

    conv5 = Conv2D(512, (3, 3), name='conv5', strides=(1, 1), padding="same")(pool4)
    conv5 = Conv2D(512, (3, 3), name='conv5a', strides=(1, 1), padding="same")(conv5)
    conv5 = Conv2D(512, (3, 3), name='conv5b', strides=(1, 1), padding="same")(conv5)
    conv5 = Conv2D(512, (3, 3), name='conv5c', strides=(1, 1), padding="same")(conv5)

    conv5 = BatchNormalization(axis=3, momentum=0.99, name='bn7')(conv5)
    conv5 = ELU(name='elu7')(conv5)
    ...
    classes4 = Conv2D(n_boxes_conv4 * n_classes, (3, 3), strides=(1, 1), padding="valid", name='classes4')(conv2)
    classes5 = Conv2D(n_boxes_conv5 * n_classes, (3, 3), strides=(1, 1), padding="valid", name='classes5')(conv3)
    classes6 = Conv2D(n_boxes_conv6 * n_classes, (3, 3), strides=(1, 1), padding="valid", name='classes6')(conv4)
    classes7 = Conv2D(n_boxes_conv7 * n_classes, (3, 3), strides=(1, 1), padding="valid", name='classes7')(conv5)
    # Output shape of `boxes`: `(batch, height, width, n_boxes * 4)`
    boxes4 = Conv2D(n_boxes_conv4 * 4, (3, 3), strides=(1, 1), padding="valid", name='boxes4')(conv2)
    boxes5 = Conv2D(n_boxes_conv5 * 4, (3, 3), strides=(1, 1), padding="valid", name='boxes5')(conv3)
    boxes6 = Conv2D(n_boxes_conv6 * 4, (3, 3), strides=(1, 1), padding="valid", name='boxes6')(conv4)
    boxes7 = Conv2D(n_boxes_conv7 * 4, (3, 3), strides=(1, 1), padding="valid", name='boxes7')(conv5)
